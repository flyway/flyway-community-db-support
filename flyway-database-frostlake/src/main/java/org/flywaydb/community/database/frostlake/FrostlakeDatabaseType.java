...
public class FrostlakeDatabaseType extends BaseDatabaseType implements CommunityDatabaseType {
    @Override
    ...
    public boolean handlesJDBCUrl(final String url) {
        return url.startsWith("jdbc:frostlake:");
    }

    @Override
    public String getDriverClass(final String url, final ClassLoader classLoader) {
        return "dev.frostlake.jdbc.DatabaseDriver";
    }
    ...
    public boolean handlesDatabaseProductNameAndVersion(final String databaseProductName,
        ...
        return databaseProductName.startsWith("Frostlake");
    }
    ...
    public Database createDatabase(final Configuration configuration,
        ...
        return new FrostlakeDatabase(configuration, jdbcConnectionFactory, statementInterceptor);
    }
    ...
    public Parser createParser(final Configuration configuration,
        ...
        return new FrostlakeParser(configuration, parsingContext);
    }
