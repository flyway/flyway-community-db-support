...
public class FrostlakeTable extends Table<FrostlakeDatabase, FrostlakeSchema> {
    FrostlakeTable(final JdbcTemplate jdbcTemplate,
        final FrostlakeDatabase database,
        final FrostlakeSchema schema,
        final String name) {
