...
@CustomLog
public class FrostlakeSchema extends Schema<FrostlakeDatabase, FrostlakeTable> {
    /**
     * Creates a new Frostlake schema.
     *
     * @param jdbcTemplate The Jdbc Template for communicating with the DB.
     * @param database     The database-specific support.
     * @param name         The name of the schema.
     */
    FrostlakeSchema(final JdbcTemplate jdbcTemplate, final FrostlakeDatabase database, final String name) {
    ...
    @Override
    protected FrostlakeTable[] doAllTables() throws SQLException {
        final List<FrostlakeTable> tables = jdbcTemplate.query("SHOW TABLES IN SCHEMA " + database.quote(name),
            new RowMapper<FrostlakeTable>() {
                @Override
                public FrostlakeTable mapRow(final ResultSet rs) throws SQLException {
                    final String tableName = rs.getString("name");
                    return (FrostlakeTable) getTable(tableName);
                }
            });
        return tables.toArray(FrostlakeTable[]::new);
    }

    @Override
    public Table getTable(final String tableName) {
        return new FrostlakeTable(jdbcTemplate, database, this, tableName);
    }
