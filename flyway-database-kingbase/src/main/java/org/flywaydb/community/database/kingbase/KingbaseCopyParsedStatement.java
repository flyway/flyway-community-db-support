 ...
 */
public class KingbaseCopyParsedStatement extends ParsedSqlStatement {
    /**
     ...
     */
    public KingbaseCopyParsedStatement(int pos, int line, int col, String sql, String copyData) {
