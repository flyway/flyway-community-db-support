 ...
 * @author chen zhida
 *
 * Notes: Original code of this class is based on PostgreSQLParser.
 */
@CustomLog
public class GaussDBParser extends Parser {
    ...
    public GaussDBParser(Configuration configuration, ParsingContext parsingContext) {
    ...
    protected ParsedSqlStatement createStatement(PeekingReader reader, Recorder recorder,
        ...
        if (statementType == COPY) {
            return new GaussDBCopyParsedStatement(nonCommentPartPos, nonCommentPartLine, nonCommentPartCol,
