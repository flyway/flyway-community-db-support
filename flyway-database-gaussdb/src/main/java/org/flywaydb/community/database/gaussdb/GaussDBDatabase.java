 ...
 * @author chen zhida
 *
 * Notes: Original code of this class is based on PostgreSQLDatabase.
 */
public class GaussDBDatabase extends Database<GaussDBConnection> {
    public GaussDBDatabase(Configuration configuration, JdbcConnectionFactory jdbcConnectionFactory, StatementInterceptor statementInterceptor) {
        super(configuration, jdbcConnectionFactory, statementInterceptor);
    }

    @Override
    protected GaussDBConnection doGetConnection(Connection connection) {
        return new GaussDBConnection(this, connection);
    }
    ...
    public void ensureSupported(Configuration configuration) {
        ...
        ensureDatabaseNotOlderThanOtherwiseRecommendUpgradeToFlywayEdition("9.1", Tier.PREMIUM, configuration);
